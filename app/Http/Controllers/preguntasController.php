...
class preguntasController extends Controller
{
    ...
    {
        $nuevo_dato=new tablaPreguntasModel;
        $nuevo_dato->descripcion=$request->nombre_pregunta;
        $nuevo_dato->idFormulario=$request->id_formulario;
        $nuevo_dato->save();
